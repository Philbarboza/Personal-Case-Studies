...
![](Answering-Business-Questions-of-a-music-store-by-using-SQLite-and-R_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](Answering-Business-Questions-of-a-music-store-by-using-SQLite-and-R_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
![](Answering-Business-Questions-of-a-music-store-by-using-SQLite-and-R_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
...
ggplot(data = q3_b, aes(x = reorder(country, -avg_rev_per_cust), 
      ...
      labs(title = "Customer Average Revenue",
        x = "Country",
...
![](Answering-Business-Questions-of-a-music-store-by-using-SQLite-and-R_files/figure-gfm/unnamed-chunk-8-4.png)<!-- -->
...
![](Answering-Business-Questions-of-a-music-store-by-using-SQLite-and-R_files/figure-gfm/unnamed-chunk-8-5.png)<!-- -->
